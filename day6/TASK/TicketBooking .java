...
public class TestTicketbooking {
    public static void main(String[] args) {
         ...
         UserThread user1 = new UserThread(bookingSystem, "Alice", 4);
    	 UserThread user2 = new UserThread(bookingSystem, "Bob", 3);
    	 UserThread user3 = new UserThread(bookingSystem, "Charlie", 5);
